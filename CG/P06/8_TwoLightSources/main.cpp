...
int main() {
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    lightingShader.setVec3("lightPos1", lightPos);
    lightingShader.setVec3("lightColor2", 1.0f, 0.0f, 0.0f);
    lightingShader.setVec3("lightPos2", -lightPos);
    ...
    lampShader.use();
    lampShader.setVec3("lampColor", 1.0f, 0.0f, 0.0f);
    lampShader.setMat4("projection", projection);
    lampShader.setMat4("view", view);
    model = glm::translate(glm::mat4(1.0f), -lightPos);
    model = glm::scale(model, glm::vec3(0.2f));  // a smaller cube
